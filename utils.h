...
#define led_to_rgbw_named(name, led)  \
	int name##r = led & 0xFF;         \
	int name##g = (led >> 8) & 0xFF;  \
	int name##b = (led >> 16) & 0xFF; \
	int name##w = (led >> 24) & 0xFF;
...
ws2811_led_t rgb_correct(int no, ws2811_led_t led, ws2811_led_t lvl);
